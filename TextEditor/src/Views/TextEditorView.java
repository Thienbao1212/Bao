    ...
    private void saveFile() {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Lưu file thành công", "Success", JOptionPane.INFORMATION_MESSAGE);
            } catch (IOException e) {
                e.printStackTrace();
                JOptionPane.showMessageDialog(this, "Xảy ra lỗi trong quá trình lưu file", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
